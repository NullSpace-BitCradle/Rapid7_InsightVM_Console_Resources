...
SELECT
    ...
    dp.title AS "Policy",
    dpr.title as "Rule",
    dprs.description AS "Compliance",
    fapr.proof,
    at.aggregated_credential_status_description AS "Status"
FROM
...
WHERE
    dp.title ILIKE 'CIS Microsoft Windows Server 2008 R2 Level One%'
    AND dpr.title ILIKE '2.3.11.7%'