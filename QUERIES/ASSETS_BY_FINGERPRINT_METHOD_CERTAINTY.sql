...
SELECT
        dfsource.fps as fingerprint_source,
        fprint.certainty as fingerprint_certainty,
...
FROM
        ...
        JOIN (
                SELECT
                        ...
                        operating_system_id,
                        certainty,
                        fingerprint_source_id as fpsid
                FROM
...
GROUP BY
        ...
        da.ip_address,
        da.host_name,
        dfsource.fps --ORDER BY fprint.certainty -- Use this line to sort by certainty
        --ORDER BY dos.description -- Use this line to sort by operating system name
ORDER BY
        dfsource.fps -- Use this line to sort by fingerprint source